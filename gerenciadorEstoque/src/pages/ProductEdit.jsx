...
const ProductEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await productService.updateProduct(id, produtoData);
      navigate('/inventario');
    } catch (error) {
      console.error('Erro ao atualizar produto:', error);
      setError(error.message || 'Erro ao atualizar produto. Por favor, tente novamente.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="flex bg-white min-h-screen">
      ...
      <div className="main-content flex-1 ml-[250px] p-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-light tracking-wide">EDITAR PRODUTO</h1>
        </div>
